...
import (
	...
	communicatorMocks "github.com/sklarsa/session-manager-plugin/src/communicator/mocks"
	"github.com/sklarsa/session-manager-plugin/src/config"
	"github.com/sklarsa/session-manager-plugin/src/encryption"
	"github.com/sklarsa/session-manager-plugin/src/encryption/mocks"
	"github.com/sklarsa/session-manager-plugin/src/log"
	"github.com/sklarsa/session-manager-plugin/src/message"
	"github.com/sklarsa/session-manager-plugin/src/version"
